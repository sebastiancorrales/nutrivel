  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <router-link :to="{name: 'CreateFuncionalDivercity'}" class="btn bnt-info">CREAR DIVERSIDAD FUNCIONAL</router-link>
          ...
          <thead>
            ...
            <tbody>
              ...
              <tr v-for="data in datas" :key="data.id">
                  ...
                  <td class="">
                    <router-link class="btn-options"  :to="{name: 'EditFuncionalDivercity', params:{id:data.id}}">Editar</router-link>
