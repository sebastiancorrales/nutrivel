  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <router-link :to="{name: 'CreatePrograms'}" class="btn bnt-info">CREAR PROGRAMA</router-link>
          ...
          <thead>
            ...
            <tbody>
              ...
              <tr v-for="data in datas" :key="data.id">
                  ...
                  <td class="">
                    <router-link class="btn-options"  :to="{name: 'EditPrograms', params:{id:data.id}}">Editar</router-link>
